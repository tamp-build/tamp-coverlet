...
#pragma warning restore CS0649
    ...
    readonly string SonarProjectKey = "tamp-build_tamp-coverlet";
    ...
    Target Test => _ => _
        ...
        .Description("Unit tests — Coverlet wrapper is pure config generation, no integration tests needed.")
        .Executes(() => DotNet.Test(s => s
            .SetProject(RootDirectory / "tests" / "Tamp.Coverlet.V6.Tests" / "Tamp.Coverlet.V6.Tests.csproj")
            .SetConfiguration(Configuration)
            .SetNoBuild(true)
    ...
    Target Pack => _ => _
        ...
        {
            s.SetProject(RootDirectory / "src" / "Tamp.Coverlet.V6" / "Tamp.Coverlet.V6.csproj");
